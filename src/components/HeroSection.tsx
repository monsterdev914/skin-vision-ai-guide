      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Your <span className="bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">
              Personal AI
            </span>
            <br />
            Dermatologist
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4 mb-12">
            <Link to="/dashboard">
              <Button size="lg" className="bg-gradient-to-r from-green-600 to-emerald-600 text-white hover:opacity-90 px-8 py-3">
